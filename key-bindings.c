...
key_bindings_init(void)
{
	static const char *const defaults[] = {
		...
		"bind -N 'Select the pane to the right of the active pane' -r h { select-pane -R }",
		"bind -N 'Select the pane to the left of the active pane' -r l { select-pane -L }",
		"bind -N 'Select the pane below the active pane' -r k { select-pane -D }",
		"bind -N 'Select the pane above the active pane' -r j { select-pane -U }",
		...
		"bind -N 'Move right in tree mode' -T choose-tree h { send -X tree-scroll-right }",
		"bind -N 'Move left in tree mode' -T choose-tree l { send -X tree-scroll-left }",
		"bind -N 'Move up in tree mode' -T choose-tree j { send -X tree-scroll-up }",
		"bind -N 'Move down in tree mode' -T choose-tree k { send -X tree-scroll-down }",
		"bind -N 'Move left in tree mode' -T choose-tree Left { send -X tree-scroll-left }",
		"bind -N 'Move right in tree mode' -T choose-tree Right { send -X tree-scroll-right }",
		"bind -N 'Move up in tree mode' -T choose-tree Up { send -X tree-scroll-up }",
		"bind -N 'Move down in tree mode' -T choose-tree Down { send -X tree-scroll-down }",
		...
		"bind -Tcopy-mode-vi J { send -X scroll-up }",
		"bind -Tcopy-mode-vi K { send -X scroll-down }",
		...
		"bind -Tcopy-mode-vi l { send -X cursor-left }",
		"bind -Tcopy-mode-vi k { send -X cursor-down }",
		"bind -Tcopy-mode-vi j { send -X cursor-up }",
		"bind -Tcopy-mode-vi z { send -X scroll-middle }",
		"bind -Tcopy-mode-vi h { send -X cursor-right }",
		"bind -Tcopy-mode-vi C-l { send -X cursor-left }",
		"bind -Tcopy-mode-vi C-h { send -X cursor-right }",
